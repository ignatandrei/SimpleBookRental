...
const BookCard = ( {author, title, description, imgId, rentId } ) => {
  return (
    <>
    <div className="tc dib br2 ba dark-gray b--black-10 w-20 mv4 mh2 h-25 mw-30 bg-near-white">
      {<img className="br2 br--top h-25 w-100" alt='book' src={`https://localhost:44308/Book/GetImage/${imgId}`} />}
      ...
      <Button onClick={async ()=>{
        ...
        var url='https://localhost:44308/UserOperations/RentBook/' +imgId;
